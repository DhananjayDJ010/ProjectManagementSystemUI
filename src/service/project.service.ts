...
export default class ProjectService {
  ...
  createUserStory(userStory: UserStory[], projectId: string) {
    let createUserStoryResponse = this.http.post(
      'https://u1vcnuupy5.execute-api.us-west-2.amazonaws.com/dev/api/v1.0/project-tracker/create/user-stories',
      userStory,
      {
        observe: 'response',
  ...
  updateUserStory(
    ...
    let updateUserStoryResponse = this.http.post(
      'https://u1vcnuupy5.execute-api.us-west-2.amazonaws.com/dev/api/v1.0/project-tracker/update/user-stories' +
        userStoryId,
      userStory,
      {
        observe: 'response',
  ...
  crateSubTask(subTask: SubTask, projectId: string, userStoryId: string) {
    let crateSubTaskResponse = this.http.post(
      'https://u1vcnuupy5.execute-api.us-west-2.amazonaws.com/dev/api/v1.0/project-tracker/create/user-story/' +
        userStoryId +
        '/sub-task',
      subTask,
      {
